...
This markdown file documents the end-to-end pipeline of data preparation for public transport-based environmental sensing. It shows how we transform raw data into output used for optmizations for limited number of vehicles {Workflow 02}. 
